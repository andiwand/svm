...
public enum MtfType {
    ...
    CONVERSION_NONE(MtfTypeConstants.MTF_CONVERSION_NONE), CONVERSION_1BIT_THRESHOLD(
	    MtfTypeConstants.MTF_CONVERSION_1BIT_THRESHOLD), CONVERSION_8BIT_GREYS(
	    MtfTypeConstants.MTF_CONVERSION_8BIT_GREYS);
