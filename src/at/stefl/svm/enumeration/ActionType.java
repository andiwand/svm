...
public enum ActionType {
    ...
    NULL(ActionTypeConstants.META_NULL_ACTION, NullAction.class), PIXEL(
	    ActionTypeConstants.META_PIXEL_ACTION, PixelAction.class), POINT(
	    ActionTypeConstants.META_POINT_ACTION, PointAction.class), LINE(
	    ActionTypeConstants.META_LINE_ACTION, LineAction.class), RECT(
	    ActionTypeConstants.META_RECT_ACTION, RectangleAction.class), ROUND_RECT(
	    ActionTypeConstants.META_ROUNDRECT_ACTION), ELLIPSE(
	    ActionTypeConstants.META_ELLIPSE_ACTION), ARC(
	    ActionTypeConstants.META_ARC_ACTION), PIE(
	    ActionTypeConstants.META_PIE_ACTION), CHORD(
	    ActionTypeConstants.META_CHORD_ACTION), POLY_LINE(
	    ActionTypeConstants.META_POLYLINE_ACTION, PolyLineAction.class), POLYGON(
	    ActionTypeConstants.META_POLYGON_ACTION, PolygonAction.class), POLY_POLYGON(
	    ActionTypeConstants.META_POLYPOLYGON_ACTION,
	    PolyPolygonAction.class), TEXT(
	    ActionTypeConstants.META_TEXT_ACTION, TextAction.class), TEXT_ARRAY(
	    ActionTypeConstants.META_TEXTARRAY_ACTION, TextArrayAction.class), STRETCH_TEXT(
	    ActionTypeConstants.META_STRETCHTEXT_ACTION), TEXT_RECT(
	    ActionTypeConstants.META_TEXTRECT_ACTION), BMP(
	    ActionTypeConstants.META_BMP_ACTION), BMP_SCALE(
	    ActionTypeConstants.META_BMPSCALE_ACTION), BMP_SCALE_PART(
	    ActionTypeConstants.META_BMPSCALEPART_ACTION), BMP_EX(
	    ActionTypeConstants.META_BMPEX_ACTION), BMP_EX_SCALE(
	    ActionTypeConstants.META_BMPEXSCALE_ACTION), BMP_EX_SCALE_PART(
	    ActionTypeConstants.META_BMPEXSCALEPART_ACTION), MASK(
	    ActionTypeConstants.META_MASK_ACTION), MASK_SCALE(
	    ActionTypeConstants.META_MASKSCALE_ACTION), MASK_SCALE_PART(
	    ActionTypeConstants.META_MASKSCALEPART_ACTION), GRADIENT(
	    ActionTypeConstants.META_GRADIENT_ACTION), HATCH(
	    ActionTypeConstants.META_HATCH_ACTION), WALLPAPER(
	    ActionTypeConstants.META_WALLPAPER_ACTION), CLIP_REGION(
	    ActionTypeConstants.META_CLIPREGION_ACTION), IS_ECT_RECT_CLIP_REGION(
	    ActionTypeConstants.META_ISECTRECTCLIPREGION_ACTION), IS_ECT_REGI_ON_CLIP_REGION(
	    ActionTypeConstants.META_ISECTREGIONCLIPREGION_ACTION), MOVE_CLIP_REGION(
	    ActionTypeConstants.META_MOVECLIPREGION_ACTION), LINE_COLOR(
	    ActionTypeConstants.META_LINECOLOR_ACTION, LineColorAction.class), FILL_COLOR(
	    ActionTypeConstants.META_FILLCOLOR_ACTION, FillColorAction.class), TEXT_COLOR(
	    ActionTypeConstants.META_TEXTCOLOR_ACTION, TextColorAction.class), TEXT_FILL_COLOR(
	    ActionTypeConstants.META_TEXTFILLCOLOR_ACTION,
	    TextFillColorAction.class), TEXT_ALIGN(
	    ActionTypeConstants.META_TEXTALIGN_ACTION, TextAlignAction.class), MAP_MODE(
	    ActionTypeConstants.META_MAPMODE_ACTION, MapModeAction.class), FONT(
	    ActionTypeConstants.META_FONT_ACTION, FontAction.class), PUSH(
	...
	try {
	    ...
	    // TODO: remove me (debugging only)
	    if (result instanceof UnsupportedAction)
		((UnsupportedAction) result).setActionType(this);
	    return result;
	} catch (Exception e) {
