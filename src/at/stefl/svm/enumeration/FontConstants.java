...
public class FontConstants {
    ...
    public static final int EMPHASISMARK_NONE = 0x0000;
    public static final int EMPHASISMARK_DOT = 0x0001;
    public static final int EMPHASISMARK_CIRCLE = 0x0002;
    public static final int EMPHASISMARK_DISC = 0x0003;
    public static final int EMPHASISMARK_ACCENT = 0x0004;
    public static final int EMPHASISMARK_STYLE = 0x00FF;
    public static final int EMPHASISMARK_POS_ABOVE = 0x1000;
    public static final int EMPHASISMARK_POS_BELOW = 0x2000;
