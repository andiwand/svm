...
public class FontDefinition extends SVMVersionObject {
    ...
    protected void serializeContent(SVMDataOutputStream out) throws IOException {
        // TODO: out.writeUnsignedShortPrefixedAsciiString(familyName);
        // TODO: out.writeUnsignedShortPrefixedAsciiString(styleName);
    ...
    protected void deserializeContent(SVMDataInputStream in, int version,
        ...
        // TODO: familyName = in.readUnsignedShortPrefixedAsciiString();
        // TODO: styleName = in.readUnsignedShortPrefixedAsciiString();
