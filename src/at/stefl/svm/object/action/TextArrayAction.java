...
public class TextArrayAction extends SVMAction {
	...
	// TODO: out.writeUnicodeOrAsciiString(string);
	out.writeIntPrefixedUTF16String(string);
	...
	// TODO: string = in.readUnicodeOrAsciiString();
	string = in.readIntPrefixedUTF16String();
